            ...
            {[1, 2, 3].map((item) => (
              ...
              >
                <div className="relative overflow-hidden rounded-xl bg-gray-200 aspect-square mb-4">
                  <img
                    src={`https://images.pexels.com/photos/${item === 1 ? '1571460' : item === 2 ? '1571468' : '1571471'}/pexels-photo-${item === 1 ? '1571460' : item === 2 ? '1571468' : '1571471'}.jpeg?auto=compress&cs=tinysrgb&w=500&h=500&dpr=1`}
